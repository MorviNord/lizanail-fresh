...
export default function Welcome() {
  return (
    <section class="mt-5 w-full max-w-4xl px-4 text-black">
      <h2 class="mb-5 text-center whitespace-nowrap text-[clamp(1rem,8vw,2.2rem)] font-['Bebas_Neue'] uppercase leading-none tracking-tighter text-yellow select-none">
        Обо мне
      </h2>
